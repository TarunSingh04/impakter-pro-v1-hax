...
const Utilitiescontent = () => {
  ...
  const saveUtility = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URI}/api/user/utility`, {
        method: "POST",
        headers: {
                  ...
                  <div className={styles.popUp1}>
                    ...
                    <div className={styles.twoselectcontainer}>
                      ...
                      <div className={styles.select1Box}>
                        ...
                        <SingleSelect2
                            placeholder="Rating1"
                            fieldData={[{label:"A",value:"A"},{label:"B",value:"B"},{label:"C",value:"C"},{label:"D",value:"D"},{label:"F",value:"F"}].sort((a, b) =>
                              a.label.localeCompare(b.label)
                            )}
