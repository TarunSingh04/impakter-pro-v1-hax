...
export const QUESTION_SET_2 = [
  ...
  {
    question_number: "3",
    question:"What other benefits for compensation do you offer (check all irrelevant boxes):",
    text_labels:[],
    choice_type: "checkbox",
    has_file : false,
    choices: [
...
export const QUESTION_SET_3 = [
  ...
  },
  {
    ...
    text_labels: [
      {
        label:
          "Percentage of immigrants/vulnerable groups compensated equally for equal work",
        placeholder: "Enter percentage",
        input_type: "number",
      },
    ],
  ...
  {
    question_number:"7",
    question: "Work stability: Does full-time vs. part-time employment and/or permanent vs. temporary staff positions entail a change in compensation level, i.e. lower for part-time or temporary work as compared to full-time or permanent?",
    choices : [
        "Yes, It is Lower",
...
export const QUESTION_SET_5 = [
  ...
  {
    question_number: "12",
    question: "If you have no certificates or the certificates you hold are not either based on ISO 45001 or SO8000, do you have any safety and/or health measures in place for your employees?",
    text_labels: [
        {
          label: "",
          placeholder: "If yes, briefly describe your employee safety and/or health measures:",
        },
      ],
      choices: ["Yes", "No"],
      choice_type: "radio",
